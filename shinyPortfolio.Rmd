...
How to run the app use this line:
shiny::runGitHub(repo = "Matthewvoss8/stat479_Repo2MatthewVoss","rstudio")
To see the code itself go to https://github.com/Matthewvoss8/stat479_Repo2MatthewVoss and look at the app.R file.
Also, note you will need to have the ggridges library activated.
