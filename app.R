...
ui<-fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      helpText("Choose age groups, nations/regions, and years to explore total malaria deaths and death rate per 100,000 people. Maneuver around the plots by selecting the different tabs on the top of the output. Please note the bar plot is only by nation/region and year and not by age group as well. Also, look at the table to explore the p-value for the test of independence between age groups and years for total deaths for each country:"),
